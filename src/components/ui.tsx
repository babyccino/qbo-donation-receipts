...
export namespace Agreements {
  ...
  export const H3 = ({ children }: { children: ReactNode }) => (
    <h3 className="text-l mb-4 font-bold tracking-tight text-gray-900 dark:text-white">
      {children}
    </h3>
  )
  ...
  export const Definitions = () => (
    <>
      ...
      <Ul>
        ...
        <li>
          <strong>Terms and Conditions</strong>(referred to as either{" "}
          <Q>the Terms and Confitions</Q>, or <Q>the Terms</Q> in this Agreement) describes Our
          policies and procedures on the collection, use and disclosure of Your information when You
          use the Service and tells You about Your privacy rights and how the law protects You. You
          can find the Privacy Policy here <a href={url + "/privacy"}>{url + "/privacy"}</a>
        </li>
      </Ul>
    </>
  )
  export const email = "gus.ryan163@gmail.com"
  export const companyName = "QBO Donation Receipts"
  export const url = "https://gusryan.me"
}
